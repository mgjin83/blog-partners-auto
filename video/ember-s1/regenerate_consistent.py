...
CHARACTERS = {
    "luna": {
        "base": (
            "beautiful young woman, auburn hair loosely tied back, "
            "green eyes, fair skin with light freckles, "
            "slender build, almond-shaped expressive eyes, delicate features"
        ),
        "eyes": "green eyes",
        ...
        "shots": {
            # --- fullbody ---
            "fullbody_front": (
                "Full body front view of this exact person, "
    ...
    "ash": {
        "base": (
            "handsome young man, dark brown messy hair, "
            "hazel eyes, light skin with stubble, "
            "tall broad-shouldered build, strong jaw, rugged features"
        ),
        "eyes": "hazel eyes",
        ...
        "shots": {
            ...
            "expressions/fear": (
                "Close-up portrait of this exact person, {eyes}, "
                "fearful expression, wide eyes, tense brow, "
                "plain grey background, focus on face"
            ),
            "expressions/anger": (
                "Close-up portrait of this exact person, {eyes}, "
                "angry expression, narrowed eyes, clenched jaw, "
                "plain grey background, focus on face"
            ),
            "expressions/sadness": (
                "Close-up portrait of this exact person, {eyes}, "
    ...
    "duchess": {
        "base": (
            "stunningly beautiful woman in her 40s, platinum blonde sleek hair, "
            "ice blue eyes, porcelain skin, "
            "tall elegant build, sharp high cheekbones, angular jawline"
        ),
        "eyes": "ice blue eyes",
    ...
    "milo": {
        "base": (
            "warm handsome young man, sandy blonde short hair, "
            "warm brown eyes, light tan skin, clean-shaven, "
            "athletic build, square jaw, warm features"
        ),
