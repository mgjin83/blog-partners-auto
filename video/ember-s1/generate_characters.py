...
CHARACTERS = {
    "luna": {
        "breed": "beautiful young woman, auburn hair loosely tied back, fair skin with light freckles",
        "eyes": "green eyes",
        "build": "slender build",
        "outfit": "florist apron over simple dark clothes",
        "extras": "almond-shaped expressive eyes, delicate features, high cheekbones",
    },
    "ash": {
        "breed": "handsome young man, dark brown messy hair, light skin with stubble",
        "eyes": "hazel eyes",
        "build": "tall broad-shouldered build",
        "outfit": "casual clothes with hoodie",
        "extras": "round warm-looking eyes, strong jaw, rugged features",
    },
    "duchess": {
        "breed": "stunningly beautiful woman in her 40s, platinum blonde sleek hair, porcelain skin",
        "eyes": "ice blue eyes",
        "build": "tall elegant build",
        "outfit": "luxurious dark clothing, jewelry",
        "extras": "large piercing slightly narrowed eyes, sharp high cheekbones, angular jawline",
    },
    "milo": {
        "breed": "warm handsome young man, sandy blonde short hair, light tan skin, clean-shaven",
        "eyes": "warm brown eyes",
        "build": "athletic build",
        "outfit": "police uniform",
        "extras": "warm open honest-looking eyes, square jaw",
    },
}
