...
SCENES = {
    ...
    "s2": {
        ...
        "prompt": (
            ...
            "this exact person wearing a florist apron over simple dark clothes, "
            "young woman with auburn hair and green eyes, "
    ...
    "s3": {
        ...
        "ref_chars": ["luna", "ash"],
        "prompt": (
            "Inside a flower shop, two people visible, "
            "a young man with dark brown messy hair and hazel eyes stumbling through the front door, "
            "torn dirty clothes with bloodstains, injured, cold air rushing in, "
            "a young woman with auburn hair and green eyes in florist apron turning sharply toward the door with shock, "
    ...
    "s4": {
        ...
        "prompt": (
            ...
            "a young woman with auburn hair and green eyes holding a wounded young man with dark brown hair and hazel eyes, "
            "her green eyes wide with worry, "
            "he looks up with fear in his hazel eyes, "
    ...
    "s5": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Close-up portrait of a young woman with auburn hair and green eyes, "
            "this exact person embracing someone, "
    ...
    "s6": {
        ...
        "prompt": (
            "Extreme close-up of a single white rose lying on a wooden floor, "
            "next to fallen scissors, "
            "a dark crimson stain slowly spreading across the white petals, "
            "warm amber lighting from above, "
            "symbolic and haunting still life, shallow depth of field, "
            "9:16 vertical composition"
        ),
    },
    "s7": {
