...
EP02 = {
    "s1": {
        ...
        "prompt": (
            ...
            "a young woman with auburn hair in a dark long coat walking toward camera, "
    ...
    "s2": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Medium shot of a young woman with auburn hair and green eyes pushing open a heavy door, "
    ...
    "s3": {
        ...
        "ref_chars": ["duchess"],
        "prompt": (
            "Low-angle medium shot of an elegant woman with platinum blonde hair and ice blue eyes, "
            "seated on a dark leather sofa, blue neon backlight, "
    ...
    "s4": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Over-the-shoulder shot from behind an elegant figure toward a young woman with auburn hair "
            "and green eyes sitting opposite, cold blue neon lighting, "
            "the young woman half in shadow holding a phone with a warm photo glowing on screen, "
    ...
    "s5": {
        ...
        "prompt": (
            ...
            "of two people smiling together in sunlight, "
    ...
    "s6": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Medium shot from behind of a young woman with auburn hair walking away "
    ...
    "s7": {
        ...
        "ref_chars": ["duchess"],
        "prompt": (
            "Close-up portrait of an elegant woman with platinum blonde hair and ice blue eyes, "
...
EP03 = {
    ...
    "s2": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Medium shot of a young woman with auburn hair and green eyes in a dark coat, "
    ...
    "s4": {
        ...
        "ref_chars": [],
        "prompt": (
            "Close-up of a shadowy figure opening a package in a dark alley, "
    ...
    "s5": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Medium shot of a young woman with auburn hair and green eyes standing under an orange streetlight, "
    ...
    "s7": {
        ...
        "prompt": (
            ...
            "a young man with sandy blonde hair and warm brown eyes in the driver seat, "
...
EP04 = {
    "s1": {
        ...
        "prompt": (
            ...
            "a young woman with auburn hair walking alone with arms crossed hugging herself, "
    ...
    "s2": {
        ...
        "prompt": (
            ...
            "a young man with sandy blonde hair and warm brown eyes grabbing the arm of a young woman with auburn hair, "
            "the young man showing worry mixed with anger in casual clothes, "
    ...
    "s3": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Close-up of a young woman with auburn hair and green eyes pulling her arm free, "
    ...
    "s4": {
        ...
        "ref_chars": ["milo"],
        "prompt": (
            "Medium shot of a young man with sandy blonde hair and warm brown eyes standing still in shock, "
            "a young woman with auburn hair walking away growing smaller in the background, "
    ...
    "s6": {
        ...
        "ref_chars": ["milo"],
        "prompt": (
            "Medium shot of a young man with sandy blonde hair and warm brown eyes sitting at a desk, "
            "opening a case file in a dim police office, "
            "a photo of an elegant woman with platinum blonde hair visible inside the file, "
...
EP05 = {
    ...
    "s2": {
        ...
        "prompt": (
            ...
            "a young woman with auburn hair and green eyes seated at a table with calm steady expression, "
    ...
    "s3": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Close-up of a young woman with auburn hair and green eyes pausing at a doorway, "
    ...
    "s4": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Medium shot of a young woman with auburn hair leaning against a wet brick wall, "
    ...
    "s6": {
        ...
        "ref_chars": ["duchess"],
        "prompt": (
            "Medium shot of an elegant woman with platinum blonde hair and ice blue eyes, "
...
EP06 = {
    "s1": {
        ...
        "prompt": (
            ...
            "a young woman with auburn hair in the background removing an apron, "
    ...
    "s2": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Close-up of a young woman with auburn hair and green eyes, "
    ...
    "s4": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Medium shot of a young woman with auburn hair and green eyes "
    ...
    "s5": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Close-up of a young woman with auburn hair sitting motionless on a dark flower shop floor, "
...
EP07 = {
    ...
    "s2": {
        ...
        "prompt": (
            ...
            "an elegant woman with platinum blonde hair and ice blue eyes on a dark sofa holding wine glass casually, "
            "a young woman with auburn hair opposite picking up a manila envelope from the table, "
    ...
    "s3": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Close-up of a young woman with auburn hair and green eyes reading documents, "
    ...
    "s5": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Medium shot of a young woman with auburn hair exiting a club into heavy rain, "
...
EP08 = {
    "s1": {
        ...
        "ref_chars": ["milo"],
        "prompt": (
            "Medium shot of a young man with sandy blonde hair and warm brown eyes "
    ...
    "s2": {
        ...
        "prompt": (
            ...
            "a stern figure in uniform speaking to a young man with sandy blonde hair and warm brown eyes, "
            "the young man's eyes hardening and fist clenching with restrained anger, "
    ...
    "s3": {
        ...
        "prompt": (
            ...
            "a young woman with auburn hair and green eyes sitting alone on the bench with fallen leaves, "
            "a young man with sandy blonde hair walking slowly toward her from a distance, "
    ...
    "s4": {
        ...
        "prompt": (
            ...
            "a young man with sandy blonde hair and warm brown eyes filled with quiet sorrow looking down, "
            "a young woman with auburn hair looking up with tears forming in green eyes, "
...
EP09 = {
    "s1": {
        ...
        "prompt": (
            ...
            "a young woman with auburn hair and green eyes arranging flowers in striped light, "
            "door bursting open with bright daylight and a young man's silhouette in the doorway, "
    ...
    "s2": {
        ...
        "prompt": (
            ...
            "a young man with dark brown hair and hazel eyes confronting a young woman with auburn hair, "
            "the young man showing rage mixed with despair, "
            "the young woman looking up with calm exhaustion in green eyes, "
    ...
    "s3": {
        ...
        "ref_chars": ["ash"],
        "prompt": (
            "Close-up of a young man with dark brown hair and hazel eyes, "
    ...
    "s4": {
        ...
        "ref_chars": ["ash"],
        "prompt": (
            "Medium shot of a young man with dark brown hair walking to a door with back to camera, "
...
EP10 = {
    ...
    "s2": {
        ...
        "prompt": (
            ...
            "an elegant woman with platinum blonde hair and ice blue eyes on sofa pushing an envelope, "
            "a young woman with auburn hair opposite taking the envelope "
    ...
    "s4a": {
        ...
        "ref_chars": ["milo"],
        "prompt": (
            "Medium shot of a young man with sandy blonde hair and warm brown eyes at a desk, "
    ...
    "s4c": {
        ...
        "prompt": (
            ...
            "ice blue eyes wide with shock and disbelief, "
    ...
    "s4d": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Close-up of a young woman with auburn hair and green eyes in a flower shop, "
    ...
    "s5": {
        ...
        "prompt": (
            ...
            "a young woman with auburn hair and green eyes behind the counter "
    ...
    "s6": {
        ...
        "ref_chars": ["luna"],
        "prompt": (
            "Medium shot of a young woman with auburn hair pulling down a shop shutter at night, "
            ...
            "the young woman pauses, looks toward the glow, expression unchanged, continues walking, "
